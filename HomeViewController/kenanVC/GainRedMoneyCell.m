...
-(void)setGainModel:(GainRedMoneyModel *)GainModel
{
    [_headImage sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",GainModel.headImage]] placeholderImage:[UIImage imageNamed:@"ic_avatar_default.png"]];
    _sexImage.image=[UIImage imageNamed:[NSString stringWithFormat:@"%@",GainModel.sexImage]];
    _nameLab.text=[NSString stringWithFormat:@"%@",GainModel.nameLab];
    _moneyLab.text=[NSString stringWithFormat:@"%@",GainModel.moneyLab];
    _timeLab.text=[NSString stringWithFormat:@"%@",GainModel.timeLab];
